...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('edit_patient/'.$data->patientId)}}" class = "btn">Edit</a>
                ...
                <div class="tab-content">
                    ...
                    <div id="step2" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="dateOfConsult" name="dateOfConsult" value="{{\Illuminate\Support\Carbon::parse($data->dateOfConsult)->format("Y-m-d")}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="chiefComplaint" name="chiefComplaint" required style="height: 100px;" readonly>
                                {{$data->chiefComplaint}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="historyillness" name="historyillness" required style="height: 100px; " readonly>
                                {{$data->historyillness}}
                                </textarea>
                            </div>
                        </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="checkbox" name="allergiesCheckbox" id="allergiesCheckbox" disabled style="margin-right: 1000px;" {{$data->allergiesInput != 0 ? 'checked' : ''}}>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="checkbox" name="hpn_Checkbox" id="hpn_Checkbox" disabled style="margin-right: 1000px;" {{$data->hpn_Input != 0 ? 'checked' : ''}}>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="checkbox" name="dm_Checkbox" id="dm_Checkbox" disabled style="margin-right: 1000px;"{{$data->dm_Input != 0 ? 'checked' : ''}}>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="checkbox" id="ptb_Checkbox" disabled style="margin-right: 1000px;"{{$data->ptb_Input != 0 ? 'checked' : ''}}>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="checkbox" id="asthma_Checkbox" disabled style="margin-right: 1000px;"{{$data->asthma_Input != 0 ? 'checked' : ''}}>
    ...
    <button type="button" class="btn btn-primary" onclick="nextStep('step6')">Next</button>
                ...
                <div id="step10" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="generalSurvey" name="generalSurvey" required style="height: 100px; " readonly>
                            {{$data->generalSurvey}}
                            </textarea>                        
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="headExam" name="headExam" required style="height: 100px; " readonly>
                            {{$data->headExam}}
                            </textarea>                        
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="faceExam" name="faceExam" required style="height: 100px; " readonly>
                            {{$data->faceExam}}
                            </textarea>                        
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="eyesExam" name="eyesExam" required style="height: 100px; " readonly>
                            {{$data->eyesExam}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="earsExam" name="earsExam" required style="height: 100px; " readonly>
                            {{$data->earsExam}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="noseExam" name="noseExam" required style="height: 100px; " readonly>
                            {{$data->noseExam}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="neckExam" name="neckExam" required style="height: 100px; " readonly>
                            {{$data->neckExam}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="cardiovascularExam" name="cardiovascularExam" required style="height: 100px; " readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="chestExam" name="chestExam" required style="height: 100px; " readonly>
                            {{$data->chestExam}}
                            </textarea>                    
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="skinExam" name="skinExam" required style="height: 100px; " readonly>
                            {{$data->skinExam}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="extremitiesExam" name="extremitiesExam" required style="height: 100px; " readonly>
                ...
                <div id="step11" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="workingImpression" name="workingImpression"required style="height: 150px; " readonly>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="hypertension_Checkbox" id="hypertension_Checkbox" disabled style="margin-right: 1000px;"{{$data->hypertension != 0 ? 'checked' : ''}}>
                                <select class="form-control" id="hypertension_Input" name="hypertension_Input" disabled>
                                            <!-- Add options for different vaccines -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="diabetes_Checkbox" id="diabetes_Checkbox" disabled style="margin-right: 1000px;" {{$data->diabetes != 0 ? 'checked' : ''}}>
                                <select class="form-control" id="diabetes_Input" name="diabetes_Input" disabled>
                ...
                <div id="step12" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="diagnostics" name="diagnostics" required style="height: 100px; " readonly>
                            {{$data->diagnostics}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="drugs" name="drugs" required style="height: 100px; " readonly>
                            {{$data->drugs}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="diet" name="diet" required style="height: 100px; " readonly>
                            {{$data->diet}}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="disposition" name="disposition" required style="height: 100px; " readonly>
                            {{$data->disposition}}
                            </textarea>
                        </div>
                    </div>
