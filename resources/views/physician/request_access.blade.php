...
<body>
    ...
    <div class="container">
        ...
        <div class="header"><p style="font-size: 30px;">Request Access</p>
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="patientId" name="patientId" value="{{$data->patientId}}"  required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="patientCodez" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Patient Code</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="patientCodez" name="patientCodez" value="{{$data->patientCode}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="attendingId" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Attending ID</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="attendingId" name="attendingId" value="{{$record->attendingId}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="physicianCodez" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Physician Code</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="physicianCodez" name="physicianCodez" value="{{$doc->physicianCode}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="accessId" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Access ID</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="accessId" name="accessId" value="{{$doc->id}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="formType" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Form Type</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="formType" name="formType" value="{{$record->formType}}" required>
                            </div>
                        </div>
                        <!-- Navigation buttons -->
