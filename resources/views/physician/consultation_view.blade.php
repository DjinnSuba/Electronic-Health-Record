...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('edit_consultation/'.$data->patientId.'/'.$data->dateOfConsult)}}" class = "btn">Edit</a>

        <div class="header"><p style="font-size: 30px;">View Consultation</p>
            ...
            <form method="POST" action="">
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="sex" name="sex" readonly disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="civilstatus" name="civilstatus" readonly disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="religion" name="religion" readonly disabled>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="subFindings" name="subFindings" value="{{$data->subFindings}}"  readonly style="height: 100px;">
                            </div>
                        </div>
                        <!-- Navigation buttons -->
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="objFindings" name="objFindings" value="{{$data->objFindings}}"  readonly style="height: 100px;">
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="assessment" name="assessment"  value="{{$data->assessment}}" readonly style="height: 100px;">
                                </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Hypertension</label>
                            <div class="col-sm-9">
                                <input type="checkbox" name="hypertension_Checkbox" id="hypertension_Checkbox" readonly disabled style="margin-right: 1000px;" {{$data->hypertension != 0 ? 'checked' : ''}} > 
                                <select class="form-control" id="hypertension_Input" name="hypertension_Input" readonly disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="diabetes_Checkbox" id="diabetes_Checkbox"  readonly disabled style="margin-right: 1000px;"  {{$data->diabetes != 0 ? 'checked' : ''}}>
                                <select class="form-control" id="diabetes_Input" name="diabetes_Input" readonly disabled>
                                    <!-- Add options for different vaccines -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="a00_b99Checkbox" id="a00_b99Checkbox" readonly disabled style="margin-right: 1000px;" {{$data->icdUmbrella['a00-b99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="c00_d48Checkbox" id="c00_d48Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['c00-d48'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="d50_d89Checkbox" id="d50_d89Checkbox"  readonly disabled  style="margin-right: 1000px;"{{$data->icdUmbrella['d50-d89'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="e00_e90Checkbox" id="e00_e90Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['e00-e90'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="f00_f99Checkbox" id="f00_f99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['f00-f99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="g00_g99Checkbox" id="g00_g99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['g00-g99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="h00_h59Checkbox" id="h00_h59Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['h00-h59'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="h60_h95Checkbox" id="h60_h95Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['h60-h95'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="i00_i99Checkbox" id="i00_i99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['i00-i99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="j00_j99Checkbox" id="j00_j99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['j00-j99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="k00_k93Checkbox" id="k00_k93Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['k00-k93'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="l00_l99Checkbox" id="l00_l99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['l00-l99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="m00_m99Checkbox" id="m00_m99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['m00-m99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="n00_n99Checkbox" id="n00_n99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['n00-n99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="o00_o99Checkbox" id="o00_o99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['o00-o99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="p00_p96Checkbox" id="p00_p96Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['p00-p96'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="q00_q99Checkbox" id=q00_q99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['q00-q99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="r00_r99Checkbox" id="r00_r99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['r00-r99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="s00_t98Checkbox" id="s00_t98Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['s00-t98'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="v01_y98Checkbox" id="v01_y98Checkbox" readonly disabled style="margin-right: 1000px; "{{$data->icdUmbrella['v01-y98'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="z00_z99Checkbox" id="z00_z99Checkbox" readonly disabled style="margin-right: 1000px;"{{$data->icdUmbrella['z00-z99'] == 'true' ? 'checked' : ''}}>
                            </div>
                        </div>
                        <!-- Navigation buttons -->
                ...
                <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="diagnostics" name="diagnostics" value="{{$data->diagnostics}}"  readonly style="height: 150px;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="drugs" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Drugs</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="drugs" name="drugs" value="{{$data->drugs}}"  readonly style="height: 150px;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="diet" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Diet</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="diet" name="diet" value="{{$data->diet}}"  readonly style="height: 150px;">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="disposition" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Disposition</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="disposition" name="disposition" value="{{$data->disposition}}"  readonly style="height: 150px;">
                            </div>
                        </div>
                    <!-- Navigation buttons -->
