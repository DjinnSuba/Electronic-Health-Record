...
<body>
    ...
    <div class="container">
        ...
        <div class="header"><p style="font-size: 30px;">View Patient Record</p>
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step2">Vital Signs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step3">Clinical History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step4">Past Medical History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step5">Family History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step6">Personal and Social History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step7" id="step7-tab">OB-Gynecological History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step8">Review of Systems</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step9">Physical Examination</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step10">Working Impression</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#step11">Plan</a>
                </li>
            </ul>
            </div>
            <!-- Form Steps -->
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="firstName" name="firstName" value="{{$data->firstName}}"readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="middleName" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Middle Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="middleName" name="middleName" value="{{$data->middleName}}"readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="dateOfConsult" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Date of Consult</label>
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="dateOfConsult" name="dateOfConsult" value="{{\Illuminate\Support\Carbon::parse($data->dateOfConsult)->format("Y-m-d")}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="timeOfConsult" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Time of Consult</label>
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfConsult" name="timeOfConsult" value="{{$data->timeOfConsult}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="civilstatus" name="civilstatus" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="birthday" name="birthday" value="{{\Illuminate\Support\Carbon::parse($data->birthday)->format("Y-m-d")}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="presentaddress" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Present Address</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="presentaddress" name="presentaddress" value="{{$data->presentaddress}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="step2" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="bp" name="bp" placeholder="mmHg" value="{{$data->bp}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pulserate" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Pulse Rate</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="pulserate" name="pulserate" placeholder="bpm"value="{{$data->pulserate}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="respirationrate" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Respiration Rate</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="respirationrate" name="respirationrate" placeholder="bpm"value="{{$data->respirationrate}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="temperature" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Temperature</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="temperature" name="temperature" placeholder="Celsius"value="{{$data->temperature}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="weight" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Weight</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="weight" name="weight" placeholder="kg"value="{{$data->weight}}"readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="height" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Height</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="height" name="height" placeholder="cm" value="{{$data->height}}"readonly>
                            </div>
                        </div>
                    ...
                    <div id="step3" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="chiefComplaint" name="chiefComplaint" value="{{$data->chiefComplaint}}" required style="height: 100px;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="historyillness" name="historyillness" value="{{$data->historyillness}}" required style="height: 100px;" readonly>
                            </div>
                        </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="allergiesInput" name="allergiesInput" placeholder="Specify allergies" value="{{$data->allergiesInput}}" readonly>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="hpn_Input" name="hpn_Input" placeholder="Specify HPN details" value="{{$data -> hpn_Input}}" readonly>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="dm_Input" name="dm_Input" placeholder="Specify DM details" value="{{$data -> dm_Input}}" readonly>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="ptb_Input" name="ptb_Input" placeholder="Specify PTB details" value="{{$data -> ptb_Input}}" readonly>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="asthma_Input" name="asthma_Input" placeholder="Specify asthma details" value="{{$data -> asthma_Input}}" readonly>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-4">
                <select class="form-control" id="covidFirstDose" name="covidFirstDose" readonly>
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" id="covidFirstDoseDate" name="covidFirstDoseDate" value="{{ $data -> covidFirstDoseDate != null ? Carbon\Carbon::parse($data->covidFirstDoseDate)->format("Y-m-d")  : null }}" readonly>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-4">
                <select class="form-control" id="covidSecondDose" name="covidSecondDose" readonly>
                    <!-- Add options for different vaccines -->
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" id="covidSecondDoseDate" name="covidSecondDoseDate" value="{{ $data -> covidSecondDoseDate != null ? Carbon\Carbon::parse($data->covidSecondDoseDate)->format("Y-m-d")  : null }}" readonly>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-4">
                <select class="form-control" id="covidBoosterDose" name="covidBoosterDose" readonly>
                    <!-- Add options for different vaccines -->
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" id="covidBoosterDoseDate" name="covidBoosterDoseDate" value="{{ $data -> covidBoosterDoseDate != null ? Carbon\Carbon::parse($data->covidBoosterDoseDate)->format("Y-m-d")  : null }}" readonly>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="otherDetails" name="otherDetails" placeholder="Specify other details" value="{{$data->otherDetails}}" readonly>
            </div>
        </div>
    </div>
</div>
    ...
    <button type="button" class="btn btn-primary" onclick="nextStep('step5')">Next</button>
                ...
                <div id="step5" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="father" name="father" style="height: 50px;" value="{{$data->father}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="mother" name="mother" style="height: 50px;" value="{{$data->mother}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="siblings" name="siblings"  style="height: 50px;" value="{{$data->siblings}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="husband" name="husband" style="height: 50px;" value="{{$data->husband}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="children" name="children" style="height: 50px;" value="{{$data->children}}" readonly>
                        </div>
                    </div>
                ...
                <div id="step6" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="checkbox" name="smoker_Checkbox" id="smoker_Checkbox" style="margin-right: 1000px;" {{$data->smoker_Input != 0 ? 'checked' : ''}} disabled>
                            <input type="text" class="form-control" id="smoker_Input" name="smoker_Input" placeholder="Specify sticks per day and years of smoking" value="{{$data->smoker_Input}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="checkbox" name="alcohol_Checkbox" id="alcohol_Checkbox" style="margin-right: 1000px;" {{$data->alcohol_Input != 0 ? 'checked' : ''}} disabled>
                            <input type="text" class="form-control" id="alcohol_Input" name="alcohol_Input" placeholder="How often? How many bottles per session? Alcohol match?"value="{{$data->alcohol_Input}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="lmp" name="lmp" value="{{$data->lmp}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="pmp" name="pmp" value="{{ $data -> pmp['pmp'] != null ? Carbon\Carbon::parse($data->pmp['pmp'])->format("Y-m-d")  : null }}" readonly>
                                </div>
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="pmp2" name="pmp2"value="{{ $data -> pmp['pmp2'] != null ? Carbon\Carbon::parse($data->pmp['pmp2'])->format("Y-m-d")  : null }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="lsc" name="lsc" value="{{$data->lsc}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="fpTechnique" name="fpTechnique" placeholder="Specify FP technique practiced" value="{{$data->fpTechnique}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="gp" name="gp" placeholder="Specify GTPAL" value="{{$data->gp}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="g1" name="g1" placeholder="CS/NSD, Term/Preterm, Complications" value="{{$data->g1}}" readonly>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="g2" name="g2" placeholder="CS/NSD, Term/Preterm, Complications" value="{{$data->g2}}" readonly>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="g3" name="g3" placeholder="CS/NSD, Term/Preterm, Complications" value="{{$data->g3}}" readonly>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="g4" name="g4" placeholder="CS/NSD, Term/Preterm, Complications" value="{{$data->g4}}" readonly>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="g5" name="g5" placeholder="CS/NSD, Term/Preterm, Complications" value="{{$data->g5}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="step8" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="weightLossCheckbox" name="weightLossCheckbox" {{$data->constitutionalSymptoms['weightLoss'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="weightLossCheckbox" style="font-size: 15px;">Weight Loss</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="headacheCheckbox" name="headacheCheckbox" {{$data->constitutionalSymptoms['headache'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="headacheCheckbox" style="font-size: 15px;">Headache</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="chillsCheckbox" name="chillsCheckbox" {{$data->constitutionalSymptoms['chills'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="chillsCheckbox" style="font-size: 15px;">Chills</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="appetiteLossCheckbox" name="appetiteLossCheckbox" {{$data->constitutionalSymptoms['appetiteLoss'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="appetiteLossCheckbox" style="font-size: 15px;">Loss of Appetite</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="bodyWeaknessCheckbox" name="bodyWeaknessCheckbox" {{$data->constitutionalSymptoms['bodyWeakness'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="constitutionalSymptomsRemarks" name="constitutionalSymptomsRemarks" style="height: 50px;" value="{{$data->constitutionalSymptoms['constitutionalSymptomsRemarks']}}" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="drynessSweatingCheckbox" name="drynessSweatingCheckbox" {{$data->skin['drynessSweating'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="dryness/sweatingCheckbox" style="font-size: 15px;">Excessive Dryness/Sweating</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="pallorCheckbox" name="pallorCheckbox" {{$data->skin['pallor'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="pallorCheckbox" style="font-size: 15px;">Pallor</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="rashesCheckbox" name="rashesCheckbox" {{$data->skin['rashes'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="skinRemarks" name="skinRemarks" style="height: 50px;" value="{{$data->skin['skinRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="earacheCheckbox" name="earacheCheckbox" {{$data->ears['earache'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="earacheCheckbox" style="font-size: 15px;">Earache</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="eardischargeCheckbox" name="eardischargeCheckbox" {{$data->ears['eardischarge'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="eardischargeCheckbox" style="font-size: 15px;">Ear Discharge</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="deafnessCheckbox" name="deafnessCheckbox" {{$data->ears['deafness'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="deafnessCheckbox" style="font-size: 15px;">Deafness</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="tinnitusCheckbox" name="tinnitusCheckbox" {{$data->ears['tinnitus'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="earsRemarks" name="earsRemarks" style="height: 50px;" value="{{$data->ears['earsRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="epistaxisCheckbox" name="epistaxisCheckbox" {{$data->noseAndSinuses['epistaxis'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="epistaxisCheckbox" style="font-size: 15px;">Epistaxis</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="nasalobstructionCheckbox" name="nasalobstructionCheckbox" {{$data->noseAndSinuses['nasalObstruction'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="nasalobstructionCheckbox" style="font-size: 15px;">Nasal Obstruction</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="nasaldischargeCheckbox" name="nasaldischargeCheckbox" {{$data->noseAndSinuses['nasalDischarge'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="nasaldischargeCheckbox" style="font-size: 15px;">Nasal Discharge</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="paranasalCheckbox" name="paranasalCheckbox" {{$data->noseAndSinuses['paranasal'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="noseRemarks" name="noseRemarks" style="height: 50px;"value="{{$data->noseAndSinuses['noseAndSinusesRemarks']}}"  readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="toothacheCheckbox" name="toothacheCheckbox" {{$data->mouthAndThroat['toothache'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="toothacheCheckbox" style="font-size: 15px;">Epistaxis</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="gumbleedingCheckbox" name="gumbleedingCheckbox" {{$data->mouthAndThroat['gumBleeding'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="gumbleedingCheckbox" style="font-size: 15px;">Gum Bleeding</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="sorethroatCheckbox" name="sorethroatCheckbox"{{$data->mouthAndThroat['soreThroat'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="sorethroatCheckbox" style="font-size: 15px;">Sore Throat</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="sorenessCheckbox" name="sorenessCheckbox"{{$data->mouthAndThroat['soreness'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="mouthRemarks" name="mouthRemarks" style="height: 50px;"value="{{$data->mouthAndThroat['mouthAndThroatRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="painCheckbox" name="painCheckbox" {{$data->neck['pain'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="painCheckbox" style="font-size: 15px;">Pain</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="limitationCheckbox" name="limitationCheckbox" {{$data->neck['limitation'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="limitationCheckbox" style="font-size: 15px;">Limitation of Movement</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="massCheckbox" name="massCheckbox" {{$data->neck['mass'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="neckRemarks" name="neckRemarks" style="height: 50px;" value="{{$data->neck['neckRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="hemoptysisCheckbox" name="hemoptysisCheckbox" {{$data->respiratorySystem['hemoptysis'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="hemoptysisCheckbox" style="font-size: 15px;">Hemoptysis</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="breathingCheckbox" name="breathingCheckbox" {{$data->respiratorySystem['breathing'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="respiratoryRemarks" name="respiratoryRemarks" style="height: 50px;" value="{{$data->respiratorySystem['respiratoryRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="palpitationsCheckbox" name="palpitationsCheckbox" {{$data->cardiovascular['palpitations'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="palpitationsCheckbox" style="font-size: 15px;">Palpitations</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="orthopneaCheckbox" name="orthopneaCheckbox" {{$data->cardiovascular['orthopnea'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="orthopneaCheckbox" style="font-size: 15px;">Orthopnea</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dsypneaCheckbox" name="dsypneaCheckbox" {{$data->cardiovascular['dsypnea'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="dsypneaCheckbox" style="font-size: 15px;">Dyspnea</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="chestpainCheckbox" name="chestpainCheckbox" {{$data->cardiovascular['chestpain'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cardiovascularRemarks" name="cardiovascularRemarks" style="height: 50px;"value="{{$data->cardiovascular['cardiovascularRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="abdominalpainCheckbox" name="abdominalpainCheckbox" {{$data->git['abdominalpain'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="abdominalpainCheckbox" style="font-size: 15px;">Abdominal Pain</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dysphagiaCheckbox" name="dysphagiaCheckbox" {{$data->git['dysphagia'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="dysphagiaCheckbox" style="font-size: 15px;">Dysphagia</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="diarrheaCheckbox" name="diarrheaCheckbox" {{$data->git['diarrhea'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="diarrheaCheckbox" style="font-size: 15px;">Diarrhea</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="constipationCheckbox" name="constipationCheckbox" {{$data->git['constipation']  == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="constipationCheckbox" style="font-size: 15px;">Constipation</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="hematemesisCheckbox" name="hematemesisCheckbox" {{$data->git['hematemesis'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="hematemesisCheckbox" style="font-size: 15px;">Hematemesis</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="melenaCheckbox" name="melenaCheckbox" {{$data->git['melena'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="melenaCheckbox" style="font-size: 15px;">Melena</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="vomitingCheckbox" name="vomitingCheckbox" {{$data->git['vomiting'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="gitRemarks" name="gitRemarks" style="height: 50px;"value="{{$data->git['gitRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="dysuriaCheckbox" name="dysuriaCheckbox" {{$data->gut['dysuria'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="dysuriaCheckbox" style="font-size: 15px;">Dysuria</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="urinaryCheckbox" name="urinaryCheckbox" {{$data->gut['urinary'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="urinaryCheckbox" style="font-size: 15px;">Urinary Frequency</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="urgencyCheckbox" name="urgencyCheckbox" {{$data->gut['urgency'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="urgencyCheckbox" style="font-size: 15px;">Urgency</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="polyuriaCheckbox" name="polyuriaCheckbox" {{$data->gut['polyuria'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="polyuriaCheckbox" style="font-size: 15px;">Polyuria</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="hesitancyCheckbox" name="hesitancyCheckbox" {{$data->gut['hesitancy'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="hesitancyCheckbox" style="font-size: 15px;">Hesitancy</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="incontinenceCheckbox" name="incontinenceCheckbox" {{$data->gut['incontinence'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="incontinenceCheckbox" style="font-size: 15px;">Incontinence</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="urineoutputCheckbox" name="urineoutputCheckbox" {{$data->gut['urineoutput'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="gutRemarks" name="gutRemarks" style="height: 50px;" value="{{$data->gut['gutRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="jointpainCheckbox" name="jointpainCheckbox" {{$data->extremities['jointpain'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="jointpainCheckbox" style="font-size: 15px;">Joint Pain</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="stiffnessCheckbox" name="stiffnessCheckbox" {{$data->extremities['stiffness'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="stiffnessCheckbox" style="font-size: 15px;">Stiffness</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="edemaCheckbox" name="edemaCheckbox" {{$data->extremities['edema'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="extremitiesRemarks" name="extremitiesRemarks" style="height: 50px;"value="{{$data->extremities['extremitiesRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="confusionCheckbox" name="confusionCheckbox" {{$data->nervousSystem['confusion'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nervousRemarks" name="nervousRemarks" style="height: 50px;" value="{{$data->nervousSystem['nervousRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="bleedingCheckbox" name="bleedingCheckbox" {{$data->hematopoietic['bleeding'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="bleedingCheckbox" style="font-size: 15px;">Bleeding Tendencies</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="bruisingCheckbox" name="bruisingCheckbox"{{$data->hematopoietic['bruising'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="hematopoieticRemarks" name="hematopoieticRemarks" style="height: 50px;"value="{{$data->hematopoietic['hematopoieticRemarks']}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="heatColdCheckbox" name="heatColdCheckbox" {{$data->endocrine['heatCold'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="heat/coldCheckbox" style="font-size: 15px;">Heat/Cold Intolerance</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="nocturiaCheckbox" name="nocturiaCheckbox" {{$data->endocrine['nocturia'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="nocturiaCheckbox" style="font-size: 15px;">Nocturia</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="polyphagiaCheckbox" name="polyphagiaCheckbox" {{$data->endocrine['polyphagia'] == 'true' ? 'checked' : ''}} disabled>
                                <label class="form-check-label" for="polyphagiaCheckbox" style="font-size: 15px;">Polyphagia</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="polydipsiaCheckbox" name="polydipsiaCheckbox" {{$data->endocrine['polydipsia'] == 'true' ? 'checked' : ''}} disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="endocrineRemarks" name="endocrineRemarks" style="height: 50px;"value="{{$data->endocrine['endocrineRemarks']}}" readonly>
                        </div>
                    </div>
                ...
                <div id="step9" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="generalSurvey" name="generalSurvey" required style="height: 100px;"value="{{$data->generalSurvey}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="headExam" name="headExam" required style="height: 100px;"value="{{$data->headExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="faceExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Face</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="faceExam" name="faceExam" required style="height: 100px;"value="{{$data->faceExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="eyesExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Eyes</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="eyesExam" name="eyesExam" required style="height: 100px;"value="{{$data->eyesExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="earsExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Ears</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="earsExam" name="earsExam" required style="height: 100px;"value="{{$data->earsExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="noseExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Nose and Paranasal Sinuses</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="noseExam" name="noseExam" required style="height: 100px;"value="{{$data->noseExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="neckExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Neck</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="neckExam" name="neckExam" required style="height: 100px;"value="{{$data->neckExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="cardiovascularExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Cardiovascular</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="cardiovascularExam" name="cardiovascularExam" required style="height: 100px;"value="{{$data->cardiovascularExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="chestExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Chest/Lungs</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="chestExam" name="chestExam" required style="height: 100px;"value="{{$data->chestExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="skinExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Skin</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="skinExam" name="skinExam" required style="height: 100px;"value="{{$data->skinExam}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="extremitiesExam" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Extremities</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="extremitiesExam" name="extremitiesExam" required style="height: 100px;"value="{{$data->extremitiesExam}}" readonly>
                        </div>
                    </div>
                    ...
                    <button type="button" class="btn btn-primary" onclick="validateAndNext('step10')">Next</button>
                </div>
                ...
                <div id="step10" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="workingImpression" name="workingImpression" required style="height: 150px;"value="{{$data->workingImpression}}" readonly>
                        </div>
                    </div>
                ...
                <div id="step11" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="diagnostics" name="diagnostics" required style="height: 150px;"value="{{$data->diagnostics}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="drugs" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Drugs</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="drugs" name="drugs" required style="height: 150px;"value="{{$data->drugs}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="diet" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Diet</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="diet" name="diet" required style="height: 150px;"value="{{$data->diet}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="disposition" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Disposition</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="disposition" name="disposition" required style="height: 150px;" value="{{$data->disposition}}" readonly>
                        </div>
                    </div>
