...
<body>
    ...
    <div class="container">
        ...
        <div class="header"><p style="font-size: 30px;">New Consultation</p>
            ...
            <!-- Form Steps -->
            <form method="POST" action="{{ url('/newConsult/'.$data->patientCode) }}">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div id="step5" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="a00_b99Checkbox" id="a00_b99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="c00_d48Checkbox" id="c00_d48Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="d50_d89Checkbox" id="d50_d89Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="e00_e90Checkbox" id="e00_e90Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="f00_f99Checkbox" id="f00_f99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="g00_g99Checkbox" id="g00_g99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="h00_h59Checkbox" id="h00_h59Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="h60_h95Checkbox" id="h60_h95Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="i00_i99Checkbox" id="i00_i99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="j00_j99Checkbox" id="j00_j99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="k00_k93Checkbox" id="k00_k93Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="l00_l99Checkbox" id="l00_l99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="m00_m99Checkbox" id="m00_m99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="n00_n99Checkbox" id="n00_n99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="o00_o99Checkbox" id="o00_o99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="p00_p96Checkbox" id="p00_p96Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="q00_q99Checkbox" id=q00_q99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="r00_r99Checkbox" id="r00_r99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="s00_t98Checkbox" id="s00_t98Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="v01_y98Checkbox" id="v01_y98Checkbox" style="margin-right: 1000px; ">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="z00_z99Checkbox" id="z00_z99Checkbox" style="margin-right: 1000px;">
                            </div>
                        </div>
                        <!-- Navigation buttons -->
