...
<div class="content">
  ...
  <div class="mt-4 mx-auto">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr class="custom-row" onclick="selectRow(1)">
          <td>1</td>
          <td><a href="{{route('physician.register')}}">E-Konsulta</a></td>
          <td>Patient Registration</td>
          <td>FCM1-Log</td>
        </tr>
        <tr class="custom-row" onclick="selectRow(2)">
          <td>2</td>
          <td><a href="{{url('/mnew-consultation')}}">Follow Up</a></td>
...
var url2 = '{{URL::to('mnew-consultation')}}';
