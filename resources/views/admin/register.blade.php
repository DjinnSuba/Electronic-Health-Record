        ...
        <div class="header">
            ...
            <form method="POST" action="{{route('register-user')}}">
                ...
                <!--div class="form-group">
                    <label for="physicianCode">Physician Code</label>
                    <input type="text" name="physicianCode" value = "{{old('physicianCode')}}" class="form-control">
                        @error('physicianCode')<p class="text text-danger">{{ $message }}</p> @enderror
                </div-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="birthday" value = "{{old('birthday')}}" class="form-control">
                        @error('birthday')<p class="text text-danger">{{ $message }}</p> @enderror
                </div>
                <div class="form-group">
                    <label for="cnumber">Contact Number</label>
                    <input type="text" name="cnumber" value = "{{old('cnumber')}}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="department" name="department">
                        <option select disabled>Select Department</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                        <option select disabled>Select Account Status</option>
