...
<body>
    ...
    <div class="container">
        <div class="mt-4 mx-auto">
            <div class="header"><p style="font-size: 30px;">Edit Progress Report</p>
            ...
            <!-- Form Steps -->
            <form method="POST" action="{{ url('/update-progress-report/'.$data->patientId.'/'.$data->dateOfConsult) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="birthday" name="birthday" value="{{\Illuminate\Support\Carbon::parse($data->dateOfConsult)->format("Y-m-d")}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="step2" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfEndConsult" value="{{$data->timeOfEndConsult}}" name="timeOfEndConsult" required>
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="managementAct" name="managementAct" placeholder="Respectfully recommending the ff.:..." required style="height: 100px; " >
                                {{$data->managementAct}}
                                </textarea>
                            </div>
                        </div>
