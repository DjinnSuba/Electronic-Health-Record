                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="medicalDiagnosis" name="medicalDiagnosis" value="{{$data->medicalDiagnosis}}"readonly style="height: 100px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" id="sex" name="sex" disabled required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="birthday" name="birthday" value="{{\Illuminate\Support\Carbon::parse($data->birthday)->format("Y-m-d")}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="phone" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Cellphone Number</label>
                            <div class="col-sm-9">
                            <input type="tel" id="phone" name="phone" class="form-control" pattern="[0][9][0-9]{9}" value="{{$data->phone}}"readonly />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refMD" name="refMD" value="{{$data->refMD}}"readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="refUnit" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Referring Unit</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refUnit" name="refUnit" value="{{$data->refUnit}}"readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfConsult" name="timeOfConsult" value="{{$data->timeOfConsult}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="timeOfEndConsult" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Time of End Consult</label>
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfEndConsult" name="timeOfEndConsult" value="{{$data->timeOfEndConsult}}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="timeOfEndConsult" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Duration</label>
                            <div class="col-sm-9">
                                <input type="input" class="form-control" id="timeOfEndConsult" name="timeOfEndConsult" value="{{date("H:i",strtotime($data->timeOfEndConsult) - strtotime($data->timeOfConsult))}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="attendees" name="attendees" value="{{$data->attendees}}" readonly>
                            </div>
                        </div>
                    ...
                    <div id="step3" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="complaints" name="complaints" placeholder="Pt. complains of having..." readonly style="height: 100px; " >
                                {{$data->complaints}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="goals" name="goals" placeholder="Pt. complains of having..." readonly style="height: 100px; " >
                                {{$data->goals}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="hpi" name="hpi" placeholder="The patient was diagnosed with..." readonly style="height: 100px; " >
                                {{$data->hpi}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="pshx" name="pshx" placeholder="Pt. is aware of the..." readonly style="height: 100px; " >
                                {{$data->pshx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="ehx" name="ehx" placeholder="Pt.’s house has..." readonly style="height: 100px; " >
                                {{$data->ehx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="pmhx" name="pmhx" placeholder="Pt. was recently..." readonly style="height: 100px; " >
                                {{$data->pmhx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="fmhx" name="fmhx" placeholder="Pt. was recently..." readonly style="height: 100px; " >
                                {{$data->fmhx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="medications" name="medications" placeholder="Pt. was given pain medications..." readonly style="height: 100px; " >
                                {{$data->medications}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <table id="vitalsTable"  style = "margin-left:auto; margin-right:auto; border: 1px solid black;">
                            ...
                            <tbody>
                                @for($i = 0; $i < $vscount; $i++)
                                <tr>
                                    <td style ="border: 1px solid black;"><input type="text" class="form-control " id="text" name="text[]" placeholder="text" value="{{$texts[$i]}}" readonly style="width: 100px; "></td>
                                    <td style ="border: 1px solid black;"><input type="text" class=" form-control" id="bp" name="bp[]" placeholder="61/100" value="{{$bps[$i]}}" readonly style="width: 100px; "></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control " id="hr" name="hr[]" placeholder="61" value="{{$hrs[$i]}}" readonly style="width: 100px;"></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control " id="osat" name="osat[]" placeholder="61" value="{{$osats[$i]}}" readonly style="width: 100px;"></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control" id="rr" name="rr[]" placeholder="61" value="{{$rrs[$i]}}" readonly style="width: 100px;"></td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
                        <div>
                            <button type="button"  class="btn btn-primary" onclick="addVitals()" disabled>Add Row</button> <!--id = "addVitals" onclick="addVitals()"-->
                        </div>      
                        <div class="form-group row">
                            <label for="significance" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Significance</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="significance" name="significance" placeholder="Pt.’s VS are elevated but ..." readonly style="height: 100px; " >
                                {{$data->significance}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <table id="assessmentsTable"  style = "margin-left:auto; margin-right:auto; border: 1px solid black; width: 75%">
                            ...
                            <tbody >
                                ...
                                <tr>
                                    <td style ="border: 1px solid black;"><input type="text" class="form-control " id="procedureTitle" name="procedureTitle[]" placeholder="Procedure Title" value="{{$procedureTitles[$i]}}" readonly></td>
                                </tr>
                                <tr>
                                    <td style ="border: 1px solid black;"><input type="text" class=" form-control" id="openText" name="openText[]" placeholder="Description" value="{{$openTexts[$i]}}" readonly style="height: 100px; "></td>
                                </tr>
                                <tr>
                                    <td style ="border: 1px solid black;"><input type="text" class=" form-control " id="procedureSignificance" name="procedureSignificance[]" placeholder="Pt. is able to perfor..." value="{{$procedureSignificances[$i]}}" readonly style="height: 100px;"></td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
                        <div id = "tableDiv" style = "margin-left:auto; margin-right:auto; width:75%"></div>
                        <button type="button"  class="btn btn-primary" onclick="addAssessments()" disabled>Add Assessments</button> <!--id = "addVitals" onclick="addVitals()"-->
                        <div class="form-group row">
                            <label for="diagnosis" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Diagnosis</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="diagnosis" name="diagnosis" placeholder="Pt.’s VS are elevated but ..." readonly style="height: 100px; " >
                                {{$data->diagnosis}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="prognosis" name="prognosis" placeholder="" readonly style="height: 100px; " >
                                {{$data->prognosis}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="plan" name="plan" placeholder="" readonly style="height: 100px; " >
                                {{$data->plan}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step6" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="references" name="references" value="{{$data->references}}" readonly style="height: 50px;">
                            </div>
                        </div>
                    ...
                    <div id="step7" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            @if ($data-> attachment)
                                <img style ="max-height:400px; max-width:400" class="img-circle" src="{{ asset('storage/images/'.$data->attachment) }}">
                            @else
                                <p style ="text-align:left; font-size:25px">No Attachment</p>
                            @endif  
                            </div>
                        </div>
