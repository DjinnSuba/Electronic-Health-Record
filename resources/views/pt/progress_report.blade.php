                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="medicalDiagnosis" name="medicalDiagnosis" value="{{$data->medicalDiagnosis}}" style="height: 100px;">
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="managementAct" name="managementAct" style="height: 100px; " >
                                </textarea>
                            </div>
                        </div>
