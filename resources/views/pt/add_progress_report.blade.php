...
<body>
    ...
    <div class="container">
        <div class="mt-4 mx-auto">
            ...
            <!-- Form Steps -->
            <form method="POST" action="{{ url('/add-progress-report/'.$data->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            <label for="diagnosis" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Medical Diagnosis</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="diagnosis" name="diagnosis" required style="height: 100px;" value="{{$data->diagnosis}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="presentaddress" name="presentaddress" required value="{{$data->presentaddress}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refMD" name="refMD" required value="{{$data->refMD}}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="refUnit" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Referring Unit</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refUnit" name="refUnit" required value="{{$data->refUnit}}" >
                            </div>
                        </div>
                    ...
                    <div id="step3" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="modeOrVenue" name="modeOrVenue" placeholder="To perform therapeutic exercises for improving LE, core..." required style="height: 100px; " >
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="changes" name="changes" placeholder="To perform therapeutic exercises for improving LE, core..." required style="height: 100px; " >
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="significance" name="significance" placeholder="Pt.’s VS are elevated but ..."required style="height: 100px;">
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="managementAct" name="managementAct" style="height: 50px;">
                            </div>
                        </div>
                    ...
                    <div id="step6" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="plan" class="form-control" id="plan" name="plan" placeholder="Respectfully recommending the ff.:..." required style="height: 100px;">
                            </div>
                        </div>
