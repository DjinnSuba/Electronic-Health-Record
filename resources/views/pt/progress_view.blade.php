...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('edit_consultation/'.$data->patientId.'/'.$data->dateOfConsult)}}" class = "btn">Edit</a>
            ...
            <!-- Form Steps -->
            <form method="POST" action="{{ url('/add-progress-report/'.$data->patientCode) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" id="birthday" name="birthday" value="{{\Illuminate\Support\Carbon::parse($data->dateOfConsult)->format("Y-m-d")}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="step2" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfEndConsult" value="{{$data->timeOfEndConsult}}" name="timeOfEndConsult" readonly>
                            </div>
                        </div>
                    ...
                    <div id="step3" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="modeOrVenue" name="modeOrVenue" placeholder="I saw the client at CTS-AA " readonly style="height: 100px; " >
                                {{$data->modeOrVenue}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="changes" name="changes" readonly placeholder="Since the last session..." style="height: 100px; " >
                                {{$data->changes}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="focus" name="focus" placeholder="To perform therapeutic exercises for improving LE, core..." readonly style="height: 100px; " >
                                {{$data->focus}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="significance" name="significance" placeholder="significance..." readonly style="height: 100px; " >
                                {{$data->significance}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="managementAct" name="managementAct" readonly style="height: 100px; " >
                                {{$data->managementAct}}
                                </textarea>
                            </div>
                        </div>
