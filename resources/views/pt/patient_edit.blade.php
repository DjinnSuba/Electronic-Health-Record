...
<body>
    ...
    <div class="container">
        <div class="mt-4 mx-auto">
            ...
            <div class="header"><p style="font-size: 30px;">Edit Assessment Report</p>
            ...
            <!-- Form Steps -->
            <form method="POST" action="{{ url('/update-assessment-report/'.$data->patientId) }}" enctype="multipart/form-data" enctype="multipart/form-data">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div id="step1" class="tab-pane fade show active">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="medicalDiagnosis" name="medicalDiagnosis" value="{{$data->medicalDiagnosis}}"required style="height: 100px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="tel" id="phone" name="phone" class="form-control" pattern="[0][9][0-9]{9}" value="{{$data->phone}}"required />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refMD" name="refMD" value="{{$data->refMD}}"required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="refUnit" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Referring Unit</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="refUnit" name="refUnit" value="{{$data->refUnit}}"required>
                            </div>
                        </div>
                    ...
                    <div id="step2" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="time" class="form-control" id="timeOfEndConsult" name="timeOfEndConsult" value="{{$data->timeOfEndConsult}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="timeOfEndConsult" class="col-sm-3 col-form-label text-right" style="font-size: 18px;">Duration</label>
                            <div class="col-sm-9">
                                <input type="input" class="form-control" id="timeOfEndConsult" name="timeOfEndConsult" value="{{date("H:i",strtotime($data->timeOfEndConsult) - strtotime($data->timeOfConsult))}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="attendees" name="attendees" value="{{$data->attendees}}" required>
                            </div>
                        </div>
                    ...
                    <div id="step3" class="tab-pane fade">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="complaints" name="complaints" placeholder="Pt. complains of having..." required style="height: 100px; " >
                                {{$data->complaints}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="goals" name="goals" placeholder="Pt. aims to decrease..." required style="height: 100px; " >
                                {{$data->goals}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="hpi" name="hpi" placeholder="The patient was diagnosed with..." required style="height: 100px; " >
                                {{$data->hpi}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step4" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="pshx" name="pshx" placeholder="Pt. is aware of the..." required style="height: 100px; " >
                                {{$data->pshx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="ehx" name="ehx" placeholder="Pt.’s house has..." required style="height: 100px; " >
                                {{$data->ehx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="pmhx" name="pmhx" placeholder="Pt. was recently..." required style="height: 100px; " >
                                {{$data->pmhx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="fmhx" name="fmhx" placeholder="Pt. was recently..." required style="height: 100px; " >
                                {{$data->fmhx}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="medications" name="medications" placeholder="Pt. was given pain medications..." required style="height: 100px; " >
                                {{$data->medications}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step5" class="tab-pane fade">
                        <table id="vitalsTable"  style = "margin-left:auto; margin-right:auto; border: 1px solid black;">
                            ...
                            <tbody>
                                @for($i = 0; $i < $vscount; $i++)
                                <tr>
                                    <td style ="border: 1px solid black;"><input type="text" class="form-control " id="text" name="text[]" placeholder="text" value="{{$texts[$i]}}" required style="width: 100px; "></td>
                                    <td style ="border: 1px solid black;"><input type="text" class=" form-control" id="bp" name="bp[]" placeholder="61/100" value="{{$bps[$i]}}" required style="width: 100px; "></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control " id="hr" name="hr[]" placeholder="61" value="{{$hrs[$i]}}" required style="width: 100px;"></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control " id="osat" name="osat[]" placeholder="61" value="{{$osats[$i]}}" required style="width: 100px;"></td>
                                    <td style ="border: 1px solid black;"><input type="number" class=" form-control" id="rr" name="rr[]" placeholder="61" value="{{$rrs[$i]}}" required style="width: 100px;"></td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="significance" name="significance" placeholder="Pt.’s VS are elevated but ..."value="{{$data->significance}}" required style="height: 100px;">
                            </div>
                        </div>
                        ...
                        <table id="assessmentsTable"  style = "margin-left:auto; margin-right:auto; border: 1px solid black; width: 75%">
                            ...
                            <tbody >
                                ...
                                <tr>
                                    <td style ="border: 1px solid black;"><textarea class="form-control" id="procedureTitle" name="procedureTitle[]" placeholder="Prognosis" required style="height: 100px; " >{{$procedureTitles[$i]}}</textarea></td>
                                </tr>
                                <tr>
                                    <td style ="border: 1px solid black;"><textarea class="form-control" id="openText" name="openText[]" placeholder="Prognosis" required style="height: 100px; " >{{$openTexts[$i]}}</textarea></td>
                                </tr>
                                <tr>
                                    <td style ="border: 1px solid black;"><textarea class="form-control" id="procedureSignificance" name="procedureSignificance[]" placeholder="Prognosis" required style="height: 100px; " >{{$procedureSignificances[$i]}}</textarea></td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="diagnosis" name="diagnosis" placeholder="Diagnosis" required style="height: 100px; " >
                                {{$data->diagnosis}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="prognosis" name="prognosis" placeholder="Prognosis" required style="height: 100px; " >
                                {{$data->prognosis}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="plan" name="plan" placeholder="Prognosis" required style="height: 100px; " >
                                {{$data->plan}}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div id="step6" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="references" name="references" value="{{$data->references}}" required style="height: 50px;">
                            </div>
                        </div>
                    ...
                    <div id="step7" class="tab-pane fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 " style ="margin: auto; display: block; width:75%;  ">
                                @if (!empty($data-> attachment))
                                <img style ="max-height:400px; max-width:400;  " src="{{ asset('storage/images/'.$data->attachment) }}">
                                @else
                                <p style ="text-align:center; font-size:25px">No Attachment</p>
                                @endif  
                            </div>
                            <div class="row" style="justify-content:right;" >
                                <div class="col-sm-8 " style =" margin-top:15px; ">
                                    <input type="file" class="form-control" id="attachment" name="attachment" style="height: 35px; width:500px; ">
                                </div>
                            </div>
                        </div>
